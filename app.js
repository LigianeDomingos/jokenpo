...
function clicado(cliqueUsuario) {
    ...
    button_computador(cliqueUsuario);

    console.log('click', cliqueUsuario);
...
function button_computador(jComputador){
    switch (jComputador) {
        case "rbutton":
            document.getElementById('rbutton_comp').style.display = 'block';
            document.getElementById('pbutton_comp').style.display = 'none';
            document.getElementById('sbutton_comp').style.display = 'none';            
            break;

        case "pbutton":            
            document.getElementById('rbutton_comp').style.display = 'none';
            document.getElementById('pbutton_comp').style.display = 'block';
            document.getElementById('sbutton_comp').style.display = 'none';         
            break;
        ...
        case "sbutton":            
            document.getElementById('rbutton_comp').style.display = 'none';
            document.getElementById('pbutton_comp').style.display = 'none';
            document.getElementById('sbutton_comp').style.display = 'block';
